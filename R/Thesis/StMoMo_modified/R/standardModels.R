...
#' 
#' @export
lc <- function(link = c("log", "logit", "cloglog", "logitP"), const = c("sum", "last", "first")) {
  link <- match.arg(link)
...
#' 
#' @export
cbd <- function(link = c("log", "logit", "cloglog", "logitP")) {
  link <- match.arg(link)
...
#' 
#' @export
apc <- function(link = c("log", "logit", "cloglog", "logitP")) {
  link <- match.arg(link)
...
#' 
#' @export
m6 <- function(link = c("log", "logit", "cloglog", "logitP")) {
  link <- match.arg(link)
  f1 <- function(x,ages) x - mean(ages)
...
#' 
#' @export
m7 <- function(link = c("log", "logit", "cloglog", "logitP")) {
  link <- match.arg(link)
  f1 <- function(x,ages) x - mean(ages)
  f2 <- function(x,ages) {
    xbar <- mean(ages)
...
#' 
#' @export
m8 <- function(link = c("log", "logit", "cloglog", "logitP"), xc) {
  link <- match.arg(link)
  f1 <- function(x,ages) x - mean(ages)
